...
var getThisGameData = function getThisGameData() {
  return $.ajax({
    method: 'GET',
...
var getUserGameData = function getUserGameData() {
  return $.ajax({
    method: 'GET',
...
var updateMove = function updateMove(updateMoveObject) {
  return $.ajax({
    method: 'PATCH',
    url: config.apiUrl + '/games/' + store.id,
...
var onClick = function onClick(event) {
  ...
  if (round % 2 === 1) {
    ...
    var _theNum = this.id.replace(/^\D+/g, '');
    boxes[_theNum].value = 'o';
  ...
  if (boxes[0].value === 'x' && boxes[1].value === 'x' && boxes[2].value === 'x') {
    ...
    if (gameOn !== true) {
      ...
      api.updateMove(updateMoveObject).then(authUi.updateMoveSuccess).catch(authUi.updateMoveFail);
...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(authUi.signUpSuccess).catch(authUi.signUpError);
};
...
var onGetChangePassword = function onGetChangePassword(event) {
  event.preventDefault();
...
var onChangePasswordBack = function onChangePasswordBack(event) {
  event.preventDefault();
  $('#change-password-form').hide();
...
var onSignUpBack = function onSignUpBack(event) {
  event.preventDefault();
  $('#sign-up-form').hide();
  $('#sign-in-form').show();
  $('#get-sign-up').show();
...
var onSignIn = function onSignIn(event) {
  ...
  api.signIn(data).then(authUi.signInSuccess).catch(authUi.signInError);
};
...
var onChangePassword = function onChangePassword(event) {
  ...
  api.changePassword(data).then(authUi.changePasswordSuccess).catch(authUi.changePasswordError);
};
...
var onSignOut = function onSignOut(event) {
  ...
  $('.turn-notifier').hide();
  api.signOut().then(authUi.signOutSuccess).catch(authUi.signOutFail);
};
...
var onUpdateMove = function onUpdateMove(event) {
  ...
  if (thisRound % 2 === 1) {
    ...
    var _theNum2 = this.id.replace(/^\D+/g, '');
    updateMoveObject.game.cell.index = _theNum2;
...
var onNewGame = function onNewGame(event) {
  ...
  api.createGame().then(authUi.createGameSuccess).catch(authUi.createGameFail);
};

var onGetGameData = function onGetGameData(event) {
  event.preventDefault();
  api.getGameData().then(authUi.getGameDataSuccess).catch(authUi.getGameDataFail);
};

var onGetThisGameData = function onGetThisGameData(event) {
  event.preventDefault();
  api.getThisGameData().then(authUi.getThisGameDataSuccess).catch(authUi.getThisGameDataFail);
};

var onGetUserStats = function onGetUserStats(event) {
  event.preventDefault();
  api.getUserGameData().then(authUi.getUserGameDataSuccess).catch(authUi.getUserGameDataFail);
  $('.stats-notifier').show();
  $('.stats-notifier').delay(2000).fadeOut('fast');
};

var onResetScore = function onResetScore(event) {
  event.preventDefault();
  player1Wins = 0;
  player2Wins = 0;
  draws = 0;
...
var signInSuccess = function signInSuccess(signInResponse) {
  ...
  api.createGame().then(createGameSuccess).catch(createGameFail);
};
...
var getGameDataSuccess = function getGameDataSuccess(getGameDataResponse) {}
// console.log('getGameDataResonse is', getGameDataResponse)


// re-add error as a parameter if necessary
;var getGameDataFail = function getGameDataFail() {
  // console.log('Error is ', error)
};

var getThisGameDataSuccess = function getThisGameDataSuccess(_getThisGameDataSuccess) {
  // console.log('getThisGameDataSuccess is', getThisGameDataSuccess)
};

var getThisGameDataFail = function getThisGameDataFail() {
  // console.log('Error is ', error)
};

var getUserGameDataSuccess = function getUserGameDataSuccess(_getUserGameDataSuccess) {
  // console.log('getUserGameDataSuccess is', getUserGameDataSuccess)
  store.userData = _getUserGameDataSuccess;
  $('#games-played').text('Games played: ' + store.userData.games.length);
  var finishedGames = 0;
  for (var i = 0; i < store.userData.games.length; i++) {
    var playerXScore = 0;
    var playerOScore = 0;
    ...
    for (var _i = 0; _i < store.userData.games.length; _i++) {
      // console.log(store.userData.games[i].cells)
      if (store.userData.games[_i].cells[0] === 'x' && store.userData.games[_i].cells[1] === 'x' && store.userData.games[_i].cells[2] === 'x') {
        playerXScore = playerXScore + 1;
      } else if (store.userData.games[_i].cells[3] === 'x' && store.userData.games[_i].cells[4] === 'x' && store.userData.games[_i].cells[5] === 'x') {
        playerXScore = playerXScore + 1;
      } else if (store.userData.games[_i].cells[6] === 'x' && store.userData.games[_i].cells[7] === 'x' && store.userData.games[_i].cells[8] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[0] === 'x' && store.userData.games[_i].cells[3] === 'x' && store.userData.games[_i].cells[6] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[1] === 'x' && store.userData.games[_i].cells[4] === 'x' && store.userData.games[_i].cells[7] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[2] === 'x' && store.userData.games[_i].cells[5] === 'x' && store.userData.games[_i].cells[8] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[0] === 'x' && store.userData.games[_i].cells[4] === 'x' && store.userData.games[_i].cells[8] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[2] === 'x' && store.userData.games[_i].cells[4] === 'x' && store.userData.games[_i].cells[6] === 'x') {
        playerXScore++;
      } else if (store.userData.games[_i].cells[0] === 'o' && store.userData.games[_i].cells[1] === 'o' && store.userData.games[_i].cells[2] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[3] === 'o' && store.userData.games[_i].cells[4] === 'o' && store.userData.games[_i].cells[5] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[6] === 'o' && store.userData.games[_i].cells[7] === 'o' && store.userData.games[_i].cells[8] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[0] === 'o' && store.userData.games[_i].cells[3] === 'o' && store.userData.games[_i].cells[6] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[1] === 'o' && store.userData.games[_i].cells[4] === 'o' && store.userData.games[_i].cells[7] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[2] === 'o' && store.userData.games[_i].cells[5] === 'o' && store.userData.games[_i].cells[8] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[0] === 'o' && store.userData.games[_i].cells[4] === 'o' && store.userData.games[_i].cells[8] === 'o') {
        playerOScore++;
      } else if (store.userData.games[_i].cells[2] === 'o' && store.userData.games[_i].cells[4] === 'o' && store.userData.games[_i].cells[6] === 'o') {
        playerOScore++;
      }
    }
...
var getUserGameDataFail = function getUserGameDataFail() {
  // console.log('Error is ', error)
};

var updateMoveSuccess = function updateMoveSuccess(updateMoveResponse) {
  // console.log('updateMoveResonse is', updateMoveResponse)
};

var updateMoveFail = function updateMoveFail() {
  // console.log('Error is ', error)
};
